...
const HomeHeroSection = () => {
  return (
    <div className="h-screen bg-gray-50 w-full relative isolate -z-10">
 <div
      ...
      <div className="absolute inset-0">
        <div className="max-w-7xl flex-col sm:flex sm:flex-row mx-auto h-2/5 sm:mt-40 mt-12 px-6 sm:px-0">
          ...
          <div className="basis-1/2 sm:px-8">
            ...
            <Link href="/pricing">
            <button className="mt-6 mb-2 w-1/2 sm:w-1/3 p-2 rounded-md border border-transparent bg-[#f1592a] hover:bg-[#f1592a]/70 sm:text-xs sm:py-1 sm:px-2 md:text-sm md:py-2 md:px-4 text-sm font-medium text-white shadow-sm">
              Book Today
            </button>
            </Link>
