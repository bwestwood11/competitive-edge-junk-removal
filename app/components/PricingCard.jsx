...
function PricingCard({price, handleSubscription}) {
            ...
            return (
                ...
                <div className='border' />
                  ...
                  <AiFillCheckCircle
                    ...
                    aria-hidden="true"
                  />
                  <p className="text-sm text-gray-500">Eco-Friendly Waste Management</p>
                </div>
                <div className='border' />
                  <div className="flex space-x-3">
                  <AiFillCheckCircle
   ...
   return (
    ...
    const dynamicSubTitle = (price) => {
        if (price.nickname === '20-Yard Dumpster') {
            return (
                <p className='text-[#f1592a] mt-1'>3-day rental</p>)}
       else if (price.nickname === '15-Yard Dumpster') {
