      ...
      <div>
        ...
        <div>
          ...
          <Link href={{
            ...
            <button
              className="mt-8 flex w-full justify-center rounded-md border border-transparent bg-[#f1592a] hover:bg-[#f1592a]/70 sm:text-xs p-2 sm:py-1 sm:px-2 md:text-sm md:py-2 md:px-4 text-sm font-medium text-white shadow-sm"
            >
              {" "}
              Schedule Today
            </button>
