...
const HowItWorksSection = () => {
  return (
    <div className='bg-gray-50 pt-8 w-full px-8'>
       ...
       <div className="mb-4">
          <p className="leading-8 text-gray-600"> Finally you will checkout with your credit or debit card. If the payment is successful you will be prompted with a success message. If the payment failed then you will be prompted with a error message. </p>
       </div>
