  ...
  return (
    ...
    <div className="relative bg-cover bg-center w-screen h-[70vh] flex justify-center items-center">
      ...
      <Image
        ...
        priority
      />
       <div className="pt-24 sm:pt-0 absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center">
    ...
    <div className="w-full hidden gap-4 z-10 sm:flex max-w-6xl mx-auto text-left mt-[50px]">
